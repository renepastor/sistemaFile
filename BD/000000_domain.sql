...
create domain dtexto   as text default '';
create domain dtexto2  as text not null;
...
create domain dbool   as boolean default true;
create domain dbool2  as boolean default false;
create domain destado  as text default 'C';
create domain dactivo  as boolean default true;
...
create domain dbyte    as char(2) default 'No';

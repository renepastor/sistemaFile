    <template>
        <v-card>
            ...
            <v-tab-item>
                <v-card flat>
                    <v-card-title class="text-h5">Carnet de Identidad</v-card-title>
                    <v-card-text>
                        <v-row>
                                ...
                                <v-carousel-item v-for="(color, i) in colors" :key="color">
                                    <v-sheet :color="color" height="100%" tile>
                                        <v-row class="fill-height" align="center" justify="center">
                                            <div class="text-h2">
                                                <v-img v-if="revision.fotoCi" :src="'../'+revision.fotoCi" :lazy-src="'../'+revision.fotoCi" :aspect-ratio="16/9" width="50rem" class="grey lighten-2">
                                                ...
                                                <div v-else> No Adjunta documento</div>
                                            </div>
                                        </v-row>
                                    </v-sheet>
                                </v-carousel-item>
            ...
            <v-tab-item>
                <v-card flat>
                    <v-card-title class="text-h5">Factura de Servicio Básico</v-card-title>
                    <v-card-text>
                        <v-row no-gutters>
                            <v-col cols="12" sm="6" md="6">
                                <div class="text-center pa-2">
                                    <nuxt-link to="/publico/categoriaServ">
                                        <v-btn outlined color="indigo">Verificar Cobertura</v-btn>
                                    </nuxt-link>
                                </div>
                            </v-col>
                            <v-carousel v-model="model">
                                <v-carousel-item v-for="(color, i) in colors" :key="color">
                                    <v-sheet :color="color" height="100%" tile>
                                        <v-row class="fill-height" align="center" justify="center">
                                            <div class="text-h2">
                                                <div class="text-h2">
                                                    <v-img v-if="revision.fotoFactura" :src="'../'+revision.fotoFactura" :lazy-src="'../'+revision.fotoFactura" :aspect-ratio="16/9" width="50rem" class="grey lighten-2">
                                                        <template v-slot:placeholder>
                                                            <v-row class="fill-height ma-0" align="center" justify="center">
                                                              <v-progress-circular indeterminate color="grey lighten-5"></v-progress-circular>
                                                            </v-row>
            ...
            <v-tab-item>
                <v-card flat>
                    <v-card-title class="text-h5">Referencia Financiera</v-card-title>
                    <v-card-text>
                        <v-row no-gutters>
                            <v-carousel v-model="model">
                                <v-carousel-item v-for="(color, i) in colors" :key="color">
                                    <v-sheet :color="color" height="100%" tile>
                                        <v-row class="fill-height" align="center" justify="center">
                                            <div class="text-h2">
                                                <v-img v-if="revision.fotoReferenciaFinanciera" :src="'../'+revision.fotoReferenciaFinanciera" :lazy-src="'../'+revision.fotoReferenciaFinanciera" :aspect-ratio="16/9" width="50rem" class="grey lighten-2">
                                                    <template v-slot:placeholder>
                                                        <v-row class="fill-height ma-0" align="center" justify="center">
                                                          <v-progress-circular indeterminate color="grey lighten-5"></v-progress-circular>
                                                        </v-row>
